 ...
 *
 * @octdoc      c:backend/imagemagick
 * @copyright   copyright (c) 2011-2014 by Harald Lapp
 * @author      Harald Lapp <harald@octris.org>
 */
class imagemagick extends context
/**/
{
    /**
     * Imagemagick MVG commands.
     *
     * @octdoc  p:imagemagick/$mvg
     * @type    array
     */
    protected $mvg = array();
    /**/
     ...
     * Constructor.
     *
     * @octdoc  m:imagemagick/__construct
     */
     ...
     *
     * @octdoc  m:imagemagick/addCommand
     ...
     * Return MVG commands.
     *
     * @octdoc  m:imagemagick/getCommands
     ...
     *
     * @octdoc  m:imagemagick/clearCommands
     */
     ...
     *
     * @octdoc  m:imagemagick/translate
     ...
     *
     * @octdoc  m:imagemagick/setStroke
     ...
     * Draw a rectangle.
     *
     * @octdoc  m:imagemagick/drawRectangle
     ...
     *
     * @octdoc  m:imagemagick/drawSpline
     ...
     *
     * @octdoc  m:imagemagick/drawLineCrossing
     * @param   int         $x                  x point.
     * @param   int         $y                  y point.
     */
     ...
     * Draw a marker.
     *
     * @octdoc  m:imagemagick/drawMarker
     * @param   int         $x                  x point.
     * @param   int         $y                  y point.
     ...
     *          metrics?
     *
     * @octdoc  m:imagemagick/drawLabel
     ...
     * *    bl -- Bottom-Left
     *
     * @octdoc  m:imagemagick/drawCorner
     * @param   int         $x                  x point.
     * @param   int         $y                  y point.
     ...
     *
     * @octdoc  m:imagemagick/drawArrowHead
     ...
     *
     * @octdoc  m:imagemagick/getFontMetrics
     ...
     *
     * @octdoc  m:imagemagick/_drawArrowHead
     * @param   int         $x              X-position of the arrow-head
     * @param   int         $y              Y-position of the arrow-head
     * @param   float       $angle          Rotation angle.
     */
